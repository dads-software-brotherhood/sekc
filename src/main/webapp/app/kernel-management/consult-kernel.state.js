    ...
    function stateConfig($stateProvider) {
        $stateProvider
            ...
            .state('consult-kernel-areaOfConcern', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'app/kernel-management/areas-management/consult-kernel-areaOfConcern.html',
            ...
            .state('consult-kernel-areaOfConcern-detail', {
                parent: 'app',
                url: '/consultKernelAreaOfConcern/{area}',
                data: {
                    authorities: ['ROLE_ADMIN'],
                ...
                views: {
                    'content@': {
                        templateUrl: 'app/kernel-management/areas-management/consult-kernel-areaOfConcern-detail.html',
                        controller: 'ConsultKernelAreaOfConcernDetailController',
                        controllerAs: 'vm'
                    }
                },
                resolve: {
