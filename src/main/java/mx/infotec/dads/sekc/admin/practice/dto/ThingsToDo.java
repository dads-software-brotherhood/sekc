...
public class ThingsToDo {
    ...
    private List<EntryCriterion> entryCriterion = null;
    @JsonProperty("completitionCriterion")
    private List<CompletitionCriterion> completitionCriterion = null;
    ...
    @JsonProperty("entryCriterion")
    public List<EntryCriterion> getEntryCriterion() {
        return entryCriterion;
    }

    @JsonProperty("entryCriterion")
    public void setEntryCriterion(List<EntryCriterion> entryCriterion) {
        this.entryCriterion = entryCriterion;
    }

    @JsonProperty("completitionCriterion")
    public List<CompletitionCriterion> getCompletitionCriterion() {
        return completitionCriterion;
    }

    @JsonProperty("completitionCriterion")
    public void setCompletitionCriterion(List<CompletitionCriterion> completitionCriterion) {
