...
public class CompetencyDto implements BasicElementDto{

    @JsonProperty("possibleLevel")
    private List<PossibleLevel> possibleLevel;
    @JsonProperty("name")
    private String name;
