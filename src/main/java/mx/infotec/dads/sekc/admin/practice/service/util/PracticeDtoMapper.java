...
public class PracticeDtoMapper {
    ...
    public static void mapThingsToDo(SEPractice entity, PracticeDto dto) {
        ...
        for (SEActivityAssociation actAssociation : EssenceFilter.filterLanguageElement(entity.getOwnedElements(), SEActivityAssociation.class)) {
            ...
            //mapActivityComposition(seActivity, actDto);
    ...
    /*
    private static void mapActivityComposition(SEActivity seActivity, Activity actDto) {
        List<String> arrayTo = new ArrayList<>();
        seActivity.getActivityAssociation().forEach((seActivityAssociation) -> {
            arrayTo.add( ((SEActivity) seActivityAssociation.getEnd2()).getIdActivityComposition());
        });
        actDto.setTo(arrayTo);
    }*/
