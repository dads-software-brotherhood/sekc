...
public class AreaOfConcern {
    ...
    private List<AreaOfConcernCompetency> competencies = null;
    @JsonIgnore
    ...
    @JsonProperty("competencies")
    public List<AreaOfConcernCompetency> getCompetencies() {
        return competencies;
    }

    @JsonProperty("competencies")
    public void setCompetencies(List<AreaOfConcernCompetency> competencies) {
